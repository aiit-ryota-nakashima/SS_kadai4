...
# テスト開始
# テスト1
./greatest_common_divisor.sh 8817 3315 > $tmp-ans1 && ERROR_EXIT "error in test1-1"
diff $tmp-ans1 $tmp-success1 || ERROR_EXIT "error in test1-2"
# テスト2
./greatest_common_divisor.sh 3315 8817 > $tmp-ans2 && ERROR_EXIT "error in test2-1"
